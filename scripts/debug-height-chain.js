  ...
  function show() {
    ...
    var items = [
      ...
      [
        'leo-content-inner',
        h('.leo-content-inner'),
        cs('.leo-content-inner', 'height'),
      ],
      ['page-stack', h('.page-stack'), cs('.page-stack', 'flex')],
      [
        'module-grid-card',
        h('.module-grid-card'),
        cs('.module-grid-card', 'flex'),
      ],
      ['ant-card-body', h('.ant-card-body'), cs('.ant-card-body', 'flex')],
      [
        'module-table-shell',
        h('.module-table-shell'),
        cs('.module-table-shell', 'flex'),
      ],
      [
        'ant-spin',
        h('.module-table-shell .ant-spin'),
        cs('.module-table-shell .ant-spin', 'flex'),
      ],
      [
        'ant-spin-container',
        h('.module-table-shell .ant-spin-container'),
        cs('.module-table-shell .ant-spin-container', 'flex'),
      ],
      [
        'ant-table-wrapper',
        h('.module-table-shell .ant-table-wrapper'),
        cs('.module-table-shell .ant-table-wrapper', 'flex'),
      ],
      [
        'ant-table',
        h('.module-table-shell .ant-table'),
        cs('.module-table-shell .ant-table', 'flex'),
      ],
      [
        'ant-table-body',
        h('.module-table-shell .ant-table-body'),
        cs('.module-table-shell .ant-table-body', 'overflow'),
      ],
    ]
