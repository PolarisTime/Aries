...
const parentSelectorMocks = vi.hoisted(() => ({
  ...
  listSalesOrderFreightImportCandidatePage: vi.fn(),
  listSalesOrderPurchaseSourceCandidatePage: vi.fn(),
...
vi.mock('@/api/sales-order-candidates', () => ({
  listSalesOrderFreightImportCandidatePage: (...args: unknown[]) =>
    parentSelectorMocks.listSalesOrderFreightImportCandidatePage(...args),
  listSalesOrderPurchaseSourceCandidatePage: (...args: unknown[]) =>
    parentSelectorMocks.listSalesOrderPurchaseSourceCandidatePage(...args),
}))
...
beforeEach(() => {
  ...
  parentSelectorMocks.listSalesOrderFreightImportCandidatePage.mockResolvedValue(
    {
      data: {
        rows: parentSelectorMocks.parentRows,
        total: parentSelectorMocks.parentRows.length,
  ...
  parentSelectorMocks.listSalesOrderPurchaseSourceCandidatePage.mockResolvedValue(
    {
      data: {
        rows: parentSelectorMocks.parentRows,
        total: parentSelectorMocks.parentRows.length,
...
describe('getOverlayStatusMap', () => {
  it('does not expose the removed pre-outbound status', () => {
    expect(getOverlayStatusMap()).not.toHaveProperty('预出库')
  })
})
...
describe('ModuleParentSelectorOverlay keyboard row interactions', () => {
  ...
  it('uses candidate query APIs for statement and import candidate modes', () => {
    ...
    expect(
      parentSelectorMocks.listSalesOrderFreightImportCandidatePage,
