...
import { contributeActionBehaviors } from '@/module-system/behavior/module-behavior-actions'
import { contributeEditorBehaviors } from '@/module-system/behavior/module-behavior-editor'
import { contributeNormalizerBehaviors } from '@/module-system/behavior/module-behavior-normalizers'
import { assembleModuleBehaviors } from '@/module-system/behavior/module-behavior-registry-core'
import { contributeSaveBehaviors } from '@/module-system/behavior/module-behavior-save'
import {
  contributeStatusBehaviors,
  protectedDeleteStatuses,
  protectedEditStatuses,
} from '@/module-system/behavior/module-behavior-statuses'
...
export type { ModuleBehaviorConfig } from '@/module-system/behavior/module-behavior-types'
