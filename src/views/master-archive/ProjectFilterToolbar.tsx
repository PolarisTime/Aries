...
interface ProjectFilterToolbarProps {
  ...
  filterCustomerId: EntityId | undefined
  onFilterCustomerIdChange: (value: EntityId | undefined) => void
  ...
  selectedRecord: LegacyModuleRecord | undefined
