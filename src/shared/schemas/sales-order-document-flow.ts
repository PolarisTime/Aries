...
export const salesOrderDocumentFlowSchema = z.looseObject({
  salesOrderId: responseEntityIdSchema,
  nodes: z.array(documentFlowNodeSchema),
  links: z.array(documentFlowLinkSchema),
})

export type SalesOrderDocumentFlow = z.output<
  typeof salesOrderDocumentFlowSchema
>
export type SalesOrderDocumentFlowNode = z.output<typeof documentFlowNodeSchema>
export type SalesOrderDocumentFlowLink = z.output<typeof documentFlowLinkSchema>
