...
export const masterDataPageConfigs: Record<string, ModulePageConfig> = {
  ...
  carriers: {
    ...
    formFields: [
      ...
      { key: 'vehicleContact', label: '车辆联系人', type: 'input' },
      { key: 'vehiclePhone', label: '车辆联系电话', type: 'input' },
      { key: 'vehiclePlate2', label: '车牌号2', type: 'input' },
      { key: 'vehicleContact2', label: '车辆联系人2', type: 'input' },
      { key: 'vehiclePhone2', label: '车辆联系电话2', type: 'input' },
      { key: 'vehiclePlate3', label: '车牌号3', type: 'input' },
      { key: 'vehicleContact3', label: '车辆联系人3', type: 'input' },
      { key: 'vehiclePhone3', label: '车辆联系电话3', type: 'input' },
      { key: 'status', label: '状态', type: 'select', defaultValue: '正常', options: enabledStatusOptions },
      { key: 'remark', label: '备注', type: 'textarea' },
    ],
    data: [],
