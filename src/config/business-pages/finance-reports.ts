...
export const financeAndReportPageConfigs: Record<string, ModulePageConfig> = {
  ...
  'pending-invoice-receipt-report': {
    ...
    title: '未收票报表',
    kicker: 'Finance',
    description: '未收票报表按采购订单明细对比已收票明细，展示尚未收票的剩余吨位与金额，供采购和财务快速追踪到票进度。',
    readOnly: true,
    actions: [{ label: '导出', type: 'primary' }],
    filters: [
    ...
    columns: [
      ...
      { title: '数量单位', dataIndex: 'quantityUnit', width: 90 },
      { title: '订单吨位', dataIndex: 'orderWeightTon', width: 110, align: 'right', type: 'weight' },
      { title: '已收票吨位', dataIndex: 'receivedInvoiceWeightTon', width: 110, align: 'right', type: 'weight' },
      { title: '未收票吨位', dataIndex: 'pendingInvoiceWeightTon', width: 110, align: 'right', type: 'weight' },
    ...
    detailFields: [
      ...
      { label: '数量单位', key: 'quantityUnit' },
      { label: '订单吨位', key: 'orderWeightTon', type: 'weight' },
      { label: '已收票吨位', key: 'receivedInvoiceWeightTon', type: 'weight' },
      { label: '未收票吨位', key: 'pendingInvoiceWeightTon', type: 'weight' },
    ...
    buildOverview: (rows) => [
      ...
      { label: '未收票吨位', value: formatWeight(sumBy(rows, 'pendingInvoiceWeightTon')) },
  ...
  receipts: {
    ...
    detailFields: [
      ...
      { label: '客户', key: 'customerName' },
      { label: '项目', key: 'projectName' },
      { label: '关联对账单', key: 'sourceStatementId' },
