...
export const purchaseOrdersPageConfig: ModulePageConfig = {
  ...
  filters: [
    ...
    { key: 'orderDate', label: i18next.t('modules.pages.purchaseOrder.filterOrderDate'), type: 'dateRange' },
  ],
  columns: [
    { title: i18next.t('modules.pages.purchaseOrder.colOrderNo'), dataIndex: 'orderNo', width: 160 },
    { title: i18next.t('modules.pages.purchaseOrder.colSupplier'), dataIndex: 'supplierName', width: 140 },
    { title: i18next.t('modules.pages.purchaseOrder.colBuyer'), dataIndex: 'buyerName', width: 110 },
    { title: i18next.t('modules.pages.purchaseOrder.colOrderDate'), dataIndex: 'orderDate', width: 120, type: 'date' },
    {
    ...
    { title: i18next.t('modules.columns.remark'), dataIndex: 'remark', width: 120 },
  ],
  defaultHiddenColumnKeys: ['buyerName', 'remark'],
  detailFields: [
    { label: i18next.t('modules.pages.purchaseOrder.colSupplier'), key: 'supplierName', row: 1 },
    { label: i18next.t('modules.pages.purchaseOrder.colOrderNo'), key: 'orderNo', row: 1 },
    { label: i18next.t('modules.pages.purchaseOrder.colOrderDate'), key: 'orderDate', type: 'date', row: 1 },
    { label: i18next.t('modules.pages.purchaseOrder.colBuyer'), key: 'buyerName', row: 2 },
