...
export const statusMap: Record<string, ModuleStatusMeta> = {
  ...
  完成采购: { text: i18next.t('modules.status.completedPurchase'), color: 'success' },
  完成入库: { text: i18next.t('modules.status.completedInbound'), color: 'success' },
  完成销售: { text: i18next.t('modules.status.completedSales'), color: 'success' },
  待核准: { text: i18next.t('modules.status.pendingApproval'), color: 'warning' },
  ...
  部分入库: { text: i18next.t('modules.status.partialInbound'), color: 'processing' },
  部分出库: { text: i18next.t('modules.status.partialOutbound'), color: 'processing' },
  ...
  待确认: { text: i18next.t('modules.status.pendingConfirm'), color: 'warning' },
  ...
  已收票: { text: i18next.t('modules.status.invoiceReceived'), color: 'success' },
  已开票: { text: i18next.t('modules.status.invoiceIssued'), color: 'success' },
  未收票: { text: i18next.t('modules.status.invoiceNotReceived'), color: 'warning' },
  部分结清: { text: i18next.t('modules.status.partialSettled'), color: 'processing' },
...
export const actionSet = [
  { key: 'create', label: i18next.t('modules.actions.create'), type: 'primary' as const },
  { key: 'export', label: i18next.t('modules.actions.export'), type: 'default' as const },
]
