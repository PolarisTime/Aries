...
export const projectArPageConfigs: Record<string, ModulePageConfig> = {
  'project-ar': {
    ...
    actions: [
      {
        key: 'export_project_ar',
        label: i18next.t('modules.pages.projectAr.export'),
        type: 'primary',
      },
    ],
    filters: [
    ...
    columns: [
      {
        title: i18next.t('modules.pages.projectAr.customerCode'),
        dataIndex: 'customerCode',
        width: 120,
      },
      {
        title: i18next.t('modules.pages.projectAr.customerName'),
        dataIndex: 'customerName',
        width: 140,
      },
      {
        title: i18next.t('modules.pages.projectAr.projectName'),
        dataIndex: 'projectName',
        width: 180,
      },
      {
        title: i18next.t('modules.pages.projectAr.projectAbbr'),
        dataIndex: 'projectNameAbbr',
        width: 120,
      },
      {
        title: i18next.t('modules.pages.projectAr.projectManager'),
    ...
    detailFields: [
      {
        label: i18next.t('modules.pages.projectAr.customerCode'),
        key: 'customerCode',
      },
      {
        label: i18next.t('modules.pages.projectAr.customerName'),
        key: 'customerName',
      },
      {
        label: i18next.t('modules.pages.projectAr.projectName'),
        key: 'projectName',
      },
      {
        label: i18next.t('modules.pages.projectAr.projectAbbr'),
        key: 'projectNameAbbr',
      },
      {
        label: i18next.t('modules.pages.projectAr.projectManager'),
        key: 'projectManager',
      },
      {
        label: i18next.t('modules.pages.projectAr.completedSales'),
        key: 'completedSalesAmount',
        type: 'amount',
      },
      {
        label: i18next.t('modules.pages.projectAr.receivedAmount'),
        key: 'receivedAmount',
        type: 'amount',
      },
      {
        label: i18next.t('modules.pages.projectAr.unreceivedAmount'),
        key: 'unreceivedAmount',
        type: 'amount',
      },
      {
        label: i18next.t('modules.pages.projectAr.prepaymentBalance'),
        key: 'prepaymentBalance',
        type: 'amount',
      },
      {
        label: i18next.t('modules.pages.projectAr.netUnreceived'),
        key: 'netUnreceivedAmount',
        type: 'amount',
      },
      {
      ...
      {
        label: i18next.t('modules.pages.projectAr.reconciledDocCount'),
        key: 'reconciledDocumentCount',
        type: 'count',
      },
      {
        label: i18next.t('modules.pages.projectAr.latestBusinessDate'),
        key: 'latestBusinessDate',
        type: 'date',
      },
    ],
    data: [],
    buildOverview: (rows) => [
      {
        label: i18next.t('modules.pages.projectAr.projectCount'),
