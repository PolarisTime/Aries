export const zhCN = {
  ...
  system: {
    ...
    userAccountEditor: {
      ...
      ownRolesLocked: '不能修改当前登录账户自己的角色集合',
      roleConflict: '（互斥）',
      status2: '状态',
    ...
    roleEditorHook: {
      ...
      deleteConfirm: '确认删除角色“{{roleName}}”吗？',
      adminRoleProtected: '系统管理员角色不能删除',
    },
    userAccountEditorHook: {
      ...
      roleSelectionOutOfBounds: '不能保留或授予超出自身权限范围的角色',
    },
  },
  print: {
    defaultTitle: '打印',
