...
export const zhCN: MessageSchema = {
  ...
  auth: {
    ...
    personalsecurity: {
      ...
      passwordHint: '修改密码后当前会话将结束，请立即使用新密码重新登录。',
      updatePassword: '更新密码',
      passwordSuccess: '密码修改成功，请立即使用新密码重新登录',
      passwordFailed: '修改失败',
      setupFailed: '获取失败',
  ...
  modules: {
    ...
    pages: {
      ...
      payment: {
        ...
        allocatedAmount: '已分配',
        remainingAmount: '未分配',
        noAllocations: '暂无分配明细',
        allocationSaved: '预付款分配已保存',
        allocationLoadFailed: '加载预付款分配失败',
        allocationSaveFailed: '保存预付款分配失败',
        statementAvailableOption: '{{statementNo}}（可分配 {{amount}}）',
        statementSelectionRequired: '第{{lineNumber}}行请选择供应商对账单',
        positiveAllocationRequired: '第{{lineNumber}}行分配金额必须大于0',
        statementAllocationExceeded:
          '第{{lineNumber}}行分配金额不能超过对账单可分配金额',
        duplicateStatementAllocation: '同一供应商对账单不能重复分配',
        paymentAllocationExceeded: '分配金额合计不能超过付款金额',
        supplier: '供应商',
        carrier: '物流商',
        draft: '草稿',
        paid: '已付款',
      ...
      supplierRefundReceipt: {
        ...
        create: '新增退款到账单',
        description:
          '按已审核采购退款单登记供应商退款到账，支持同一采购退款分次到账。',
        refundReceiptNo: '退款到账单号',
        purchaseRefundId: '采购退款单ID',
        supplierCode: '供应商编码',
        supplierName: '供应商名称',
        settlementCompany: '结算主体',
        receiptDate: '到账日期',
        ...
        bankAcceptance: '银行承兑',
        cash: '现金',
        parentPurchaseRefund: '采购退款单',
        selectPurchaseRefund: '选择采购退款单',
      },
      receipt: {
        receipt: '收款单',
        createReceipt: '新增收款单',
      ...
      purchaseRefund: {
        title: '采购退款单',
        description:
          '采购退款单以采购订单原始付款口径和已审核入库为准，登记供应商应退的未入库差额。',
        placeholderRefundNo: '输入退款单号或采购订单号',
        refundNo: '退款单号',
        purchaseOrderNo: '采购订单号',
        supplierCode: '供应商编码',
        supplier: '供应商',
        ...
        importPurchaseOrder: '导入采购订单退款差额',
      },
      purchaseInbound: {
        title: '采购入库',
        description:
      ...
      inventoryReport: {
        ...
        stockWeight: '结存重量（吨）',
        onHandWeight: '现存重量（吨）',
        reservedWeight: '预留重量（吨）',
        availableWeight: '可用重量（吨）',
        pieceWeight: '每件件重（吨）',
        unit: '单位',
