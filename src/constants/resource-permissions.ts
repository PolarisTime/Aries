...
export const menuResourceMap: Record<string, string> = {
  ...
  'settlement-accounts': 'settlement-account',
  'purchase-orders': 'purchase-order',
  'purchase-inbounds': 'purchase-inbound',
  'sales-orders': 'sales-order',
  'sales-outbounds': 'sales-outbound',
  'freight-bills': 'freight-bill',
  'purchase-contracts': 'purchase-contract',
  'sales-contracts': 'sales-contract',
  'inventory-report': 'inventory-report',
  'io-report': 'io-report',
  'pending-invoice-receipt-report': 'pending-invoice-receipt-report',
  'supplier-statements': 'supplier-statement',
  'customer-statements': 'customer-statement',
  'freight-statements': 'freight-statement',
  receipts: 'receipt',
  payments: 'payment',
  'invoice-receipts': 'invoice-receipt',
  'invoice-issues': 'invoice-issue',
  'receivables-payables': 'receivable-payable',
  ...
  'role-settings': 'role',
  'role-action-editor': 'role',
  'database-management': 'database',
  'session-management': 'session',
  'api-key-management': 'api-key',
  'security-keys': 'security-key',
  'print-templates': 'print-template',
}

export const resourceLabelMap: Record<string, string> = {
  dashboard: '工作台',
  material: '商品资料',
  supplier: '供应商资料',
  customer: '客户资料',
